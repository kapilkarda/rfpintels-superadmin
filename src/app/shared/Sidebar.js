      ...
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <ul className="nav">
          ...
          {/* <li className={ this.isPathActive('/dashboard') ? 'nav-item active' : 'nav-item' }>
            ...
            <span className="menu-title">  <i className="mdi mdi-home menu-icon"></i> <Trans>Dashboard</Trans></span>
             
            </Link>
          </li> */}
                                                   {/* REMOVED ACTIVE KEYWORD FROM CLASSNAME TO GET DESIRED VIEW
           <li  className={ this.isPathActive('/management/CompanyManage') ? 'nav-item active active-side-item' : 'nav-item' }> */}
          <li  className={ this.isPathActive('/management/CompanyManage') ? 'nav-item active-side-item' : 'nav-item' }>
               {/* REMOVED "nav-link" CLASSNAME TO GET DESIRED VIEW
               <Link className="nav-link" to="/management/CompanyManage"> */}
            <Link  className="nav-link-data" to="/management/CompanyManage">
          
            <span className="menu-title">  <i className={ this.isPathActive('/management/CompanyManage') ? "mdi menu-icon-color mdi-buffer menu-icon ": "mdi mdi-buffer menu-icon" }></i> <Trans>Company Management</Trans></span>
            {/* <span className="menu-title">  <i className="mdi  mdi-buffer menu-icon"></i> <Trans>Company Management</Trans></span> */}
             
            </Link>
          </li>
          <li className={ this.isPathActive('/management/subscribermanagment') ? 'nav-item active-side-item' : 'nav-item' }>
            <Link className="nav-link-data" to="/management/subscribermanagment">
          
            <span className="menu-title">  <i className={ this.isPathActive('/management/subscribermanagment') ?"mdi menu-icon-color mdi-trackpad menu-icon": "mdi mdi-trackpad menu-icon"}></i> <Trans>Subscriber Management</Trans></span>
             
            </Link>
          </li>
          <li className={ this.isPathActive('/management/usermanagment') ? 'nav-item active-side-item' : 'nav-item' }>
            <Link className="nav-link-data" to="/management/usermanagment">          
            <span className="menu-title">  <i className={ this.isPathActive('/management/usermanagment') ? "mdi menu-icon-color mdi-home menu-icon" : "mdi mdi-home menu-icon"}></i> <Trans>User Management</Trans></span>             
            </Link>
          </li>
          <li className={ this.isPathActive('/management/extrapage') ? 'nav-item active-side-item' : 'nav-item' }>
            <Link className="nav-link-data" to="/management/extrapage">          
            <span className="menu-title">  <i className={ this.isPathActive('/management/extrapage') ? "mdi menu-icon-color mdi-home menu-icon" : "mdi mdi-home menu-icon"}></i> <Trans>Extra Page</Trans></span>             
            </Link>
          </li>
          {/* <li className={ this.isPathActive('/basic-ui') ? 'nav-item active' : 'nav-item' }>
            <div className={ this.state.basicUiMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('basicUiMenuOpen') } data-toggle="collapse">
              <span className="menu-title"> <i className="mdi mdi-crosshairs-gps menu-icon"></i><Trans>Basic UI Elements</Trans></span>
