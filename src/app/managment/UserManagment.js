...
console.log(indexed, "aniloodapifoajsifjuioajiof");
const [addUserbtndata, setAddUserbtndata] = useState({});
console.log("addUserbtndata", addUserbtndata);
...
console.log(setAddUserbtndata, "anillodha");
};
      ...
      <Modal
         ...
         <div>
            ...
            <div className="text-right mt-2">
               ...
               className="btn btn-info"
               // onClick={() => Savecancel()}
               //  onClick={()=>handleEditSubmit(indexed)}
               // onClick={updateUser}
