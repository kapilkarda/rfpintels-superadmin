...
import {image1} from '../../assets/img/others/img-17.jpg';
import {image2} from "../../assets/img/others/Frame.png"

const backgroundURL= {image2}
	...
	return (
		<div className={`h-100 ${theme === 'light' ? 'bg-white' : ''}`}>
			...
			<Col xs={0} sm={0} md={0} lg={12}>
					...
					<img className="h-100" src= {image1} style={{opacity: "0.8", position: "relative"}} alt=""/>
				...
				<Col xs={20} sm={20} md={24} lg={12}>
					<div className="container d-flex flex-column justify-content-center h-100">
						...
						<Col xs={24} sm={24} md={20} lg={12} xl={8}>
							...
							<Col xs={24} sm={24} md={20} lg={12} xl={8}>
							<p>Don't have an account?<a href="/auth/subscription">Sign Up</a></p>
							</Col>
						</Row>
